    ...
    <ul class="layui-nav layui-layout-right">
        <li class="layui-nav-item">
            ...
            <dl class="layui-nav-child">
                ...
                <dd><a href="/campustrading/HistoryView" target="content" title="历史订单">历史订单<span class="orderNum" id="historyNum"></span></a></dd>
...
<script>
    ...
    //获取用户各种订单（待付款，待发货，待收货、待评价,历史订单）的数量
