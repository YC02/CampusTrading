...
public class OrderController {
    ...
    public String historyView(){//进入待评价的页面
    ...
    @RequestMapping(value = "HistoryOrder",produces = "application/json;charset=utf-8")
    @ResponseBody
    public String historyOrder(String uName){//查看历史订单的详细信息
        List<Orders> list=orderService.historyOrder(uName);
        return JSONObject.toJSONString(list);
    }
